...
if l == 9:
    plt.title(f'Simulation of the Solar system ({mult} year)')
elif l ==10:
    plt.title(f'Simulation of a fly-by of a Sun-like star through the Solar system ({mult} years)')
...
solar_animation = animation.FuncAnimation(fig, animate, interval = 1)
plt.show()
