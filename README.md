...
Our solar system consists of the Sun, the planets and other smaller objects. For simplicity this project will neglect the last category and deal with the Sun and the planets only. Each body, whether it’s the Sun or any of the planets, experiences gravitational forces from other bodies. The total gravitational force ($Fi$) experienced by a body (with index i) can be described as following:
